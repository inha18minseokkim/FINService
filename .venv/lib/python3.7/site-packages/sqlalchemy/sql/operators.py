    ...
    def startswith(
        ...
        :param escape: a character which when given will render with the
          ...
          :paramref:`.ColumnOperators.startswith.autoescape`::
            ...
            somecolumn.startswith("foo%bar^batRes", escape="^", autoescape=True)

          Where above, the given literal parameter will be converted to
          ``"foo^%bar^^batRes"`` before being passed to the database.
    ...
    def istartswith(
        ...
        :param escape: a character which when given will render with the
          ...
          :paramref:`.ColumnOperators.istartswith.autoescape`::
            ...
            somecolumn.istartswith("foo%bar^batRes", escape="^", autoescape=True)
    ...
    def endswith(
        ...
        :param escape: a character which when given will render with the
          ...
          :paramref:`.ColumnOperators.endswith.autoescape`::
            ...
            somecolumn.endswith("foo%bar^batRes", escape="^", autoescape=True)
    ...
    def contains(self, other: Any, **kw: Any) -> ColumnOperators:
        ...
        :param escape: a character which when given will render with the
          ...
          :paramref:`.ColumnOperators.contains.autoescape`::
            ...
            somecolumn.contains("foo%bar^batRes", escape="^", autoescape=True)
    ...
    def icontains(self, other: Any, **kw: Any) -> ColumnOperators:
        ...
        :param escape: a character which when given will render with the
          ...
          :paramref:`.ColumnOperators.contains.autoescape`::
            ...
            somecolumn.icontains("foo%bar^batRes", escape="^", autoescape=True)
