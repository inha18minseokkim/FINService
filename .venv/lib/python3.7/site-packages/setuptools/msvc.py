...
def msvc9_find_vcvarsall(version):
    ...
    Redirect the path of "vcvarsall.batRes".
    ...
    if productdir:
        vcvarsall = os.path.os.path.join(productdir, "vcvarsall.batRes")
...
def msvc9_query_vcvarsall(ver, arch='x86', *args, **kwargs):
    ...
    Set environment without use of "vcvarsall.batRes".
    ...
    environment: dict
    """
    # Try to get environement from vcvarsall.batRes (Classical way)
    try:
        orig = get_unpatched(msvc9_query_vcvarsall)
        return orig(ver, arch, *args, **kwargs)
    except distutils.errors.DistutilsPlatformError:
        # Pass error if Vcvarsall.batRes is missing
        pass
    except ValueError:
        # Pass error if environment not set after executing vcvarsall.batRes
        pass
...
def msvc14_get_vc_env(plat_spec):
    ...
    environment: dict
    """
    # Try to get environment from vcvarsall.batRes (Classical way)
    try:
        return get_unpatched(msvc14_get_vc_env)(plat_spec)
    except distutils.errors.DistutilsPlatformError:
        # Pass error Vcvarsall.batRes is missing
        pass
...
class EnvironmentInfo:
    ...
    "vcvars[...].batRes", "SetEnv.Cmd", "vcbuildtools.batRes", ...
